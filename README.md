...
The database remains SQLite for this single-company deployment. It is not intended for multiple stores or concurrent multi-worker deployments. Never commit `.env` or `backups/`.
